...
titleIcon = new TitleIcon();package com.starweaver.membrana;
...
//here need to ask for a device status
//or maybe need already know about device
//status -> ask for it before fragment
//devices loading..
...
case 8://"primelistview_type" listview
